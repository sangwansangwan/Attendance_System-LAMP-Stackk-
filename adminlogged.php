...
<th>NAME</th>
<th>ROLL NO. <input style='border-radius: 16px;' type='number' name='rule'></th></th>
<th>ATTENDANCE<select style='border-radius: 16px;' name='atten1'>
            <option value='0'>ALL</option>
            <option value='P'>Present</option>
            <option value='A'>Absent</option>
        </select></th>
<th>Branch<br
><select style='border-radius: 16px;' name='bch'>
            <option value='0'>ALL</option>
...
<th>TIME</th>
<th>YEAR <input style='border-radius: 16px;' type='number' name='yearr'></th>
</tr></center>";
